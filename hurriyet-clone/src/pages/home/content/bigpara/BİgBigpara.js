...
export default function BİgBigpara() {
    return (
        <div className='-translate-y-[20rem]'>
            ...
            <div className='flex gap-x-10'>
                ...
                <div className="flex justify-center items-center max-w-full ">
                    <div className="w-[51rem] h-2 bg-[#ff8a1b]"></div>
                </div>
            ...
            <div className="content flex gap-x-4 pt-8">
                <div className='gap-y-2 h-full '>
                    <NavLink to='/' className='w-[60rem]'>
                        <div className="">
                            <img src={items[3].image} className="object-cover w-[38.5rem] h-[28rem] rounded-msm flex-shrink-0"></img>
                        </div>
                        <div className='flex flex-col p-4 bg-white w-[38.5rem] h-[13rem] mb-8'>
                    ...
                    <div className='flex gap-x-8 gap-'>
                        <NavLink to='/' className=''>
                            <div className="">
                                <img src={items[3].image} className="object-cover w-[17.5rem] h-[13.5rem] rounded-md flex-shrink-0"></img>
                            </div>
                            <div className='w-[17.5rem] h-[9rem]  bg-white p-4 flex flex-col gap-y-2'>
                        ...
                        <NavLink to='/' className=''>
                            <div className="">
                                <img src={items[2].image} className="object-cover w-[17.5rem] h-[13.5rem] rounded-md flex-shrink-0"></img>
                            </div>
                            <div className='w-[17.5rem] h-[9rem]  bg-white p-4 flex flex-col gap-y-2'>
                                <span className='font-bold text-[17px]'>{items[1].title}</span>
                                <span className='text-[9px] text-red-600 font-bold'>{items[1].hastag}</span>
                ...
                <div className=''>
                    ...
                    <div>
                        <NavLink to='/' className=''>
                            ...
                            <div className='w-[17.5rem] h-[7rem]  bg-white p-3 flex flex-col gap-y-2 mb-[1rem]'>
                                <span className='font-bold text-[17px]'>{items[1].title}</span>
                                <span className='text-[9px] text-red-600 font-bold'>{items[1].hastag}</span>
                            </div>
                        </NavLink>
