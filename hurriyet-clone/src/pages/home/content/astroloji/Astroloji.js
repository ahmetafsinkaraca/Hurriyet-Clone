...
import BigAstroloji from './BigAstroloji';
import MiddleAstroloji from './MiddleAstroloji';
import SmallAstroloji from './SmallAstroloji';

export default function Astroloji() {
