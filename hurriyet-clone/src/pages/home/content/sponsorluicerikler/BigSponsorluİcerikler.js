...
export default function BigSponsorluİcerikler() {
    return (
        <div className='-mt-[18rem] '>
            ...
            <div className='flex px-14 py-6'>
                ...
                <div className="flex justify-center items-center w-full">
                    <div className="w-[46rem] h-2 bg-[#4283EF]"></div>
                </div>
            ...
            <div className='flex items-start gap-x-4 px-14'>
                {items && items.slice(0, 4).map((item, index) => (
                    <NavLink key={index} to={items.index}>
                        <div>
                            <img src={item.image} className='w-[18rem] h-[15rem]' />
