...
import BigSponsorluİcerikler from './BigSponsorluİcerikler';
import MiddleSponsorluİcerikler from './MiddleSponsorluİcerikler';
import SmallSponsorluİcerikler from './SmallSponsorluİcerikler';

export default function Sponsorluİcerikler() {
    ...
    return (
        <>
            {isBigScreen &&
                <BigSponsorluİcerikler />
            }
            {isMiddleScreen &&
                <MiddleSponsorluİcerikler />
            }
            {isSmallScreen &&
                <SmallSponsorluİcerikler />
            }
        </>
    )
}
