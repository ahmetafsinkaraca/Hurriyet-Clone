...
export default function MiddleCarouselDunya() {
                        ...
                        return (
                            <div key={index} className='flex flex-col items-center justify-center'>
                                <NavLink to={`/details/${dunyas.index}`} className='flex flex-col'>
                                    <img src={dunyas.image} className='w-[48rem] h-[30rem] hover:opacity-70 transition duration-300 rounded' />
                                    <span className='font-bold text-[28px] hover:opacity-70 transition duration-300'>{dunyas.title}</span>
                                    <span className='w-[48rem] py-3 hover:opacity-70 transition duration-300'>{dunyas.description}</span>
                        ...
                        return (
                            <NavLink key={index} to={`/details/${dunyas.index}`} className='flex flex-col'>
                                <div className='flex gap-x-5 py-10'>
                                    <img src={dunyas.image} className='w-[27rem] hover:opacity-70 transition duration-300 rounded' />
                                    <div className='flex flex-col'>
                                        <span className='w-[22rem] font-bold text-3xl hover:opacity-70 transition duration-300'>{dunyas.title}</span>
                                        <span className='w-[22rem] py-3 hover:opacity-70 transition duration-300 text-[17px] font-light'>{dunyas.description}</span>
