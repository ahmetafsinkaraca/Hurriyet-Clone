...
import MiddleCarouselDunya from './components/MiddleCarouselDunya';

export default function MiddleDunya() {
  return (
    <div className='bg-white w-full h-full flex justify-center text-wrap'>

        <div className='flex flex-col pt-8'>
            <div className='flex  items-center justify-center gap-x-[28rem]'>

                <div className='flex flex-col py-6 justify-start items-start '>
                    <div className='flex text-xs font-bold flex-shrink-0'>
                        ...
                        <NavLink to='/'><span className='hover:opacity-70 transiton duration-300 cursor-pointer'>DÜNYA</span></NavLink>
                    </div>
